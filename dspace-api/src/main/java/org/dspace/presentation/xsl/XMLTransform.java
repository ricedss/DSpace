...
public class XMLTransform
{
            ...
            throws AuthorizeException, SQLException, IOException, JDOMException, TransformerException
    {
        ...
        xmlfile = builder.build(sourceBitstream.retrieve());
        ...
        if (transformBitstreamLinks)
        {
            ...
            for (Bitstream bitstream : getBitstreamsInBundle(item, "ORIGINAL")) {
        ...
        {
            Map<String, String> links = new HashMap<String,String>(700);
            for (Bitstream bitstream : getBitstreamsInBundle(item, "THUMBNAIL")) {
...
// *******************   Link replacement   ********************************
    ...
    private List<Bitstream> getBitstreamsInBundle(Item item, String bundleName) {
        // get named bundles
        List<Bundle> bundles = new ArrayList<Bundle>();
        try
        {
            bundles.addAll(Arrays.asList(item.getBundles(bundleName)));
        }
        catch (SQLException e)
        {
            // nothing - invalid bundle name given, just ignore it
        }
