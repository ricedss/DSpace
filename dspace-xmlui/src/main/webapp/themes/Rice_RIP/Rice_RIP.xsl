                        ...
                        <xsl:for-each select="key('issues-by-vol', @vol)">
                            <xsl:choose>
                                ...
                                <xsl:when test="contains(@num, 'Special Issue')">
                                    ...
                                    <a href="{$context_path}/handle/{$collection_handle}/search?{$query_string}=series:%22Volume%20{$volnum},%20{@num}%22">
                                    <!-- i18n: Issue N (YYYY-MM-DD) -->
                                            <i18n:translate>
                                                <i18n:text>xmlui.Periodicals.IssueNumberAndDate</i18n:text>
                                                <i18n:param>
                                ...
                                <xsl:when test="contains($volnum, '-')">
                                    ...
                                    <a href="{$context_path}/handle/{$collection_handle}/search?{$query_string}=series:%22Volume%20{@realvol},%20Number%20{@num}%22">
                                    <!-- i18n: Issue N (YYYY-MM-DD) -->
                                            <i18n:translate>
                                                <i18n:text>xmlui.Periodicals.IssueNumberAndDate</i18n:text>
                                                <i18n:param>
                                ...
                                <xsl:otherwise>
                                    <a href="{$context_path}/handle/{$collection_handle}/search?{$query_string}=series:%22Volume%20{$volnum},%20Number%20{@num}%22">
                                    <!-- i18n: Issue N (YYYY-MM-DD) -->
                                            <i18n:translate>
                                                <i18n:text>xmlui.Periodicals.IssueNumberAndDate</i18n:text>
                                                <i18n:param>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <tr class="ds-table-row">
                                 <th><span class="bold"><i18n:text>xmlui.Periodicals.Issue</i18n:text>:</span></th>
                                 <td>
                                    <a href="{$context_path}/handle/{$collection_handle}/search?{$query_string}=series%3A%28%22Volume+{$vol}%2C+,%20Number+{$num}%22+-%22Page%22%29">Issue <xsl:value-of select="$num"/></a>
                                 </td>
                                      </tr>
